...
public class HomeActivity extends AppCompatActivity implements HomeView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(this);
               ...
               presnter =new HomePresenter(this);
               presnter.getMeals();
...
//        {            Log.w("meal name",mealresult.getIdMeal());
//
//
//        }
    ...
    public void setCategory(List<Categories.Category> category) {
          ...
          GridLayoutManager layoutManger=new GridLayoutManager(this,3,GridLayoutManager.VERTICAL,false);
          recyclerViewCategory.setLayoutManager(layoutManger);
...
//             new AlertDialog.Builder(this).setTitle(msg).setMessage(msg).show();
